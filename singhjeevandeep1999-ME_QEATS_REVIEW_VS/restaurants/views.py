...
class GetTags(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        api_c = restaurants.clarifai_tag_suggestions.Clarifai_tag()
        token=api_c.get_access_token('CLARIFAI_API_KEY')
        # print(token)  
        tags=api_c.get_tags_suggestions(token,image_url)
        # tags = restaurants.clarifai_tag_suggestions.get_tags_suggestions(token,image_url)
...
class ShareReview(ListAPIView):
    def post(self, request, *args, **kwargs):
        ...
        # add support to share a review to a Pinterest boa  rd
